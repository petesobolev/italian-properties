      ...
      <section className="bg-[var(--color-cream)] border-t border-[var(--color-sand)]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
              ...
              {Object.entries(regionInfo)
                ...
                .map(([slug, { name }]) => (
                  <Link
                    key={slug}
                    href={`/${slug}`}
                    className="inline-flex items-center gap-2 px-5 py-2.5 bg-[var(--color-stone)] rounded-lg text-[var(--color-text)] font-medium hover:shadow-md transition-shadow duration-200 border border-[var(--color-sand)]"
                  >
                    {name}
                    <svg
          ...
          <div className="mt-12 pt-8 border-t border-[var(--color-sand)]">
            <p className="text-sm text-[var(--color-text-muted)] text-center leading-relaxed max-w-3xl mx-auto">
